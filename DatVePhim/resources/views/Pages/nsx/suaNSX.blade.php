  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Sửa NSX</h4>
    </div>
    <div class="modal-body">
        <form action=""  method="POST" id="suadienvien" enctype="multipart/form-data">
           ...
           <div class="form-group">
            ...
            <input type="" name="tentheloai" value="" class="form-control" id="nsx" placeholder="Enter "> 
...
<div class="modal-footer">
    <button type="submit" class="btn btn-success" id="luunsx">Lưu</button>
